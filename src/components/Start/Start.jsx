...
const Start = ({setimgurl,setmobileview,mobileview})=>{
    ...
    return(
        <>
        {takingframe&&(
            <div className="fixed flex flex-col justify-center items-center top-0 left-0 h-[100vh] w-full backdrop-blur-md z-[2] transition-all"><img src="/webframeloading-2.gif" alt="" width={"80px"}/><h3 className="text-lg font-bold">Taking Your Frame</h3></div>
        )}
